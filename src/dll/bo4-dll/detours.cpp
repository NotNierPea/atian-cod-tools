...
// Detours
static inject::DetourInfo<void, uint64_t, scriptinstance::ScriptInstance, char*, bool> dScrVm_Error{
    "ScrVm_Error", bo4::OFFSET_ScrVm_Error, ScrVm_Error
};
static inject::DetourInfo<void*, byte, uint64_t*, bool, int> dDB_FindXAssetHeader{ "DB_FindXAssetHeader",
                                                                                   bo4::OFFSET_DB_FindXAssetHeader,
                                                                                   DB_FindXAssetHeader };
...
static inject::DetourInfo<void, uint32_t, scriptinstance::ScriptInstance, byte*, const char*, bool> dScrVm_RuntimeError{
    "ScrVm_RuntimeError", bo4::OFFSET_ScrVm_RuntimeError, ScrVm_RuntimeError
};

static inject::DetourInfo<bool, byte*, uint32_t*, bool*> dCScr_GetFunctionReverseLookup{
    "CScr_GetFunctionReverseLookup", bo4::OFFSET_CScr_GetFunctionReverseLookup, CScr_GetFunctionReverseLookup
};
static inject::DetourInfo<bool, byte*, uint32_t*, bool*> dScr_GetFunctionReverseLookup{
    "Scr_GetFunctionReverseLookup", bo4::OFFSET_Scr_GetFunctionReverseLookup, Scr_GetFunctionReverseLookup
};
static inject::DetourInfo<bo4::BuiltinFunction, uint32_t, bo4::BuiltinType*, int*, int*> dScr_GetFunction{
    "Scr_GetFunction", bo4::OFFSET_Scr_GetFunction, Scr_GetFunction
};
static inject::DetourInfo<bo4::BuiltinFunction, uint32_t, bo4::BuiltinType*, int*, int*> dCScr_GetFunction{
    "CScr_GetFunction", bo4::OFFSET_CScr_GetFunction, CScr_GetFunction
};
static inject::DetourInfo<bo4::BuiltinFunction, uint32_t, bo4::BuiltinType*, int*, int*> dScr_GetMethod{
    "Scr_GetMethod", bo4::OFFSET_Scr_GetMethod, Scr_GetMethod
};
static inject::DetourInfo<bo4::BuiltinFunction, uint32_t, bo4::BuiltinType*, int*, int*> dCScr_GetMethod{
    "CScr_GetMethod", bo4::OFFSET_CScr_GetMethod, CScr_GetMethod
};
