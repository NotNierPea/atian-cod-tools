    ...
    namespace {
        std::shared_ptr<xsk::gsc::context> GetXensikContext(ScriptFileInformation* info) {
            ...
            case VMI_IW_BIN_AW:
                switch (info->plt) {
                case PLATFORM_PC:
                    return std::make_shared<xsk::gsc::s1_pc::context>(inst);
                case PLATFORM_PLAYSTATION:
                    return std::make_shared<xsk::gsc::s1_ps::context>(inst);
                case PLATFORM_XBOX:
                    return std::make_shared<xsk::gsc::s1_xb::context>(inst);
                }
                break;
            case VMI_IW_BIN_WW2:
                return std::make_shared<xsk::gsc::s2::context>(inst);
            case VMI_IW_BIN_VANGUARD:
                return std::make_shared<xsk::gsc::s4::context>(inst);
            case VMI_IW_BIN_RM_MW1:
                return std::make_shared<xsk::gsc::h1::context>(inst);
            case VMI_IW_BIN_RM_MW2:
                return std::make_shared<xsk::gsc::h2::context>(inst);
            case VMI_IW_BIN_GHOSTS:
                switch (info->plt) {
                case PLATFORM_PC:
                    return std::make_shared<xsk::gsc::iw6_pc::context>(inst);
                case PLATFORM_PLAYSTATION:
                    return std::make_shared<xsk::gsc::iw6_ps::context>(inst);
                case PLATFORM_XBOX:
                    return std::make_shared<xsk::gsc::iw6_xb::context>(inst);
                }
                break;
            case VMI_IW_BIN_IW:
                return std::make_shared<xsk::gsc::iw7::context>(inst);
            case VMI_IW_BIN_MW19:
                return std::make_shared<xsk::gsc::iw8::context>(inst);
