...
namespace compatibility::scobalula::csi {
    const char* CordycepGameName(CordycepGame game) {
        ...
        case CG_MW2R:
            return "Modern Warfare 2 Remastered";
        case CG_MW4:
            return "Modern Warfare 2019";
        case CG_MW5:
            return "Modern Warfare II";
        case CG_MW6:
            return "Modern Warfare III";
        case CG_VANGUARD:
            return "Vanguard";
        case CG_BO6:
            return "Black Ops 6";
    ...
    std::filesystem::path ActsCsiLocation() { return utils::GetProgDir() / ACTS_CSI_LOCATION; }
