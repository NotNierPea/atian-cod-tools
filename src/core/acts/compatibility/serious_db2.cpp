...
namespace {
    ...
    class LookupMaps {
      ...
      public:
        ...
        bool operator!() { return opCodeToSID.empty(); }
...
namespace compatibility::serious::db2 {
    OPCode ConvertFrom(SeriousId id) { return Maps().ConvertFrom(id); }

    SeriousId ConvertTo(OPCode id) { return Maps().ConvertTo(id); }
