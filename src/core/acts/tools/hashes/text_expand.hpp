...
namespace tool::hash::text_expand {
    ...
    void GetDynamicPtr(size_t max, void (*func)(const char* str, void* data), void* data = nullptr,
                       const char* dict = cdict, size_t n = sizeof(cdict) - 1);
    ...
    void GetDynamicAsyncDictPtr(size_t max, void (*func)(const char** str, void* data), const char** dict,
                                BS::thread_pool* pool, void* data = nullptr, AsyncStop* stop = nullptr);
    ...
    template<typename T = void>
    void GetDynamicAsyncDict(size_t max, void (*func)(const char** str, T* data), const char** dict,
                             T* data = nullptr) {
