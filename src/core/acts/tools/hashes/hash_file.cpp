...
namespace {
    ...
    int mach_hashes(int argc, const char* argv[]) {
        ...
        while (is->good() && std::getline(*is, line)) {
            ...
            size_t t{};
            if ((alg & HASH_FNVA) && (::hash::Hash64A(str) & ::hash::MASK60) == hash)
                t++;
            if ((alg & HASH_FNVA32) && (::hash::HashX32(str) & ::hash::MASK60) == hash)
                t++;
            if ((alg & HASH_PRIME) && (::hash::HashPrime(str) & ::hash::MASK60) == hash)
                t++;
            if ((alg & HASH_DJB2) && (::hash::HashDJB2(str) & ::hash::MASK60) == hash)
                t++;
            if ((alg & HASH_SCR_T10) && (::hash::HashT10Scr(str) & ::hash::MASK60) == hash)
                t++;
            if ((alg & HASH_SCR_T10_SP) && (::hash::HashT10ScrSP(str) & ::hash::MASK60) == hash)
                t++;
            if ((alg & HASH_OMNVAR) && (::hash::HashT10OmnVar(str) & ::hash::MASK60) == hash)
                t++;
            if ((alg & HASH_SCR_T89) && (::hash::HashT89Scr(str) & ::hash::MASK60) == hash)
                t++;
            if ((alg & HASH_SCR_JUP) && (::hash::HashJupScr(str) & ::hash::MASK60) == hash)
                t++;
            if ((alg & HASH_RES) && (::hash::HashIWAsset(str) & ::hash::MASK60) == hash)
                t++;
            if ((alg & HASH_DVAR) && (::hash::HashIWDVar(str) & ::hash::MASK60) == hash)
                t++;
            if ((alg & HASH_T7) && (::hash::HashT7(str) & ::hash::MASK60) == hash)
                t++;
