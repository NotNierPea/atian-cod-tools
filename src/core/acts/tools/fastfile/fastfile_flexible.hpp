...
namespace fastfile::flexible {
    ...
    constexpr bool IsFlexibleDataMagic(uint32_t magic) { return magic == MAGIC || magic == MAGIC_V2; }
    ...
    class FlexibleFastFileReader {
      ...
      public:
        ...
        constexpr FlexibleFastFileChunk* begin() { return chunks; }
        constexpr FlexibleFastFileChunk* end() { return &chunks[chunksCount]; }
