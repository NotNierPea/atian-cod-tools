...
#define STATICARRAY_GET_SAFE(__arr, __idx)                                                                             \
    ((__idx) < ACTS_ARRAYSIZE((__arr)) ? __arr[(__idx)] : utils::va("invalid:%d", (__idx)))
    ...
    class ImplWorker : public Worker {
        ...
        void Unlink(fastfile::FastFileOption& opt, void* ptr) {
            ...
            json.WriteFieldValueScrStringArray("weakPointsTags", ACTS_ARRAYSIZE(asset.weakPointsTags),
                                               asset.weakPointsTags);
            ...
            */
            ...
            json.WriteFieldValueXAssetArray("primaryWeapons", cw::ASSET_TYPE_WEAPON,
                                            ACTS_ARRAYSIZE(asset.primaryWeapons), &asset.primaryWeapons[0]);
            ...
            json.WriteFieldValueXAssetArray("aivsaiMeleeBundles", cw::ASSET_TYPE_SCRIPTBUNDLE,
                                            ACTS_ARRAYSIZE(asset.aivsaiMeleeBundles), &asset.aivsaiMeleeBundles[0]);
            json.WriteFieldValueXAsset("aiFxBundle", cw::ASSET_TYPE_SCRIPTBUNDLE, asset.aiFxBundle);
            json.WriteFieldValueXAsset("aiNotetrackBoneMappingBundle", cw::ASSET_TYPE_SCRIPTBUNDLE,
            ...
            json.WriteFieldValueXAssetArray("animMappingTables", cw::ASSET_TYPE_ANIMMAPPINGTABLE,
                                            ACTS_ARRAYSIZE(asset.animMappingTables), &asset.animMappingTables[0]);
            ...
            json.WriteFieldValueXAssetArray("character", cw::ASSET_TYPE_CHARACTER, ACTS_ARRAYSIZE(asset.character),
                                            &asset.character[0]);

            json.WriteFieldValueBool("nameHashed", asset.namedHashed);
            if (asset.unk8a0)
                json.WriteFieldValueHash("unk8a0", asset.unk8a0);
            ...
            json.WriteFieldValueScrStringArray("requiredBones", ACTS_ARRAYSIZE(asset.validations.requiredBones),
                                               &asset.validations.requiredBones[0]);
            json.EndObject();

            std::filesystem::path outFile{ opt.m_output / "cw" / "source" / "tables" / "aitype" /
