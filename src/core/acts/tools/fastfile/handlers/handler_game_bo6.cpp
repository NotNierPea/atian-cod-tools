...
namespace fastfile::handlers::bo6 {
    ...
    namespace {
        ...
        int32_t GetMappedTypeStub(T10HashAssetType hash) { return gcx.assetNames.GetMappedType(hash)->type; }
        ...
        class FFHandlerImpl : public fastfile::FFHandler {
          public:
            ...
            FFHandlerImpl()
                : fastfile::FFHandler(handlerId, handlerName, compatibility::scobalula::csi::CordycepGame::CG_BO6) {}
            ...
            void Handle(fastfile::FastFileOption& opt, core::bytebuffer::ByteBuffer& ffData,
                ...
                // idk
                // std::filesystem::path outUnk{ gcx.opt->m_output / gamePath / "source" / "tables" / "data" / "unk" /
                ...
                //		stringsOs << i << ",0x" << std::hex << gcx.assets.unk10[i] << "," <<
                // hashutils::ExtractTmp("hash", gcx.assets.unk10[i]) << "\n";
                //	}
                //}
                //
