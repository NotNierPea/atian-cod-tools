...
namespace fastfile::handlers::bo4 {
    ...
    class BO4JsonWriter : public core::hashes::raw_file_extractor::JsonWriter {
      public:
        ...
        void WriteValueScrString(ScrString_t val) { WriteValueString(GetScrString(val)); }
...
template<>
struct std::formatter<fastfile::handlers::bo4::ScrString_t, char>
    : utils::BasicFormatter<fastfile::handlers::bo4::ScrString_t> {};