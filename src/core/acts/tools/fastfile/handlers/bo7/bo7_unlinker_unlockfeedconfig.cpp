...
namespace {
    ...
    class ImplWorker : public Worker {
        ...
        void Unlink(fastfile::FastFileOption& opt, fastfile::FastFileContext& ctx, void* ptr) override {
            ...
            std::filesystem::path outFile{ opt.m_output / gamePath / "source" / "tables" / "unlockfeedconfig" /
    ...
    utils::MapAdder<ImplWorker, HandlerHashedAssetType, Worker> impl{
        GetWorkers(), HandlerHashedAssetType::SATH_ASSET_UNLOCKFEEDCONFIG, sizeof(UnlockFeedConfig)
    };
} // namespace