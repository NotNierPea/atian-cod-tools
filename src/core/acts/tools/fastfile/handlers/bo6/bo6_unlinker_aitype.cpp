...
namespace {
    ...
    class ImplWorkerBundleList : public Worker {
      ...
      public:
        ...
        void Unlink(fastfile::FastFileOption& opt, fastfile::FastFileContext& ctx, void* ptr) override {
            ...
            std::filesystem::path outFile{ opt.m_output / gamePath / "source" / "tables" / dir /
    ...
    class ImplWorker : public Worker {
        ...
        void Unlink(fastfile::FastFileOption& opt, fastfile::FastFileContext& ctx, void* ptr) override {
            ...
            if (asset.characters.unk18)
                json.WriteFieldValueNumber("characters.unk18", asset.characters.unk18);
            if (asset.characters.unk1c)
                json.WriteFieldValueNumber("characters.unk1c", asset.characters.unk1c);
            ...
            std::filesystem::path outFile{ opt.m_output / gamePath / "source" / "tables" / "ai" / "type" /
    ...
    utils::MapAdder<ImplWorker, bo6::T10HashAssetType, Worker> impl{ GetWorkers(),
                                                                     bo6::T10HashAssetType::T10H_ASSET_AITYPE,
                                                                     sizeof(AIType) };
} // namespace