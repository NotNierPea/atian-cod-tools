...
namespace {
    ...
    class ImplWorker : public Worker {
        ...
        void Unlink(fastfile::FastFileOption& opt, fastfile::FastFileContext& ctx, void* ptr) override {
            ...
            if (!asset->len && std::filesystem::exists(outFile))
            ...
            //
            // if (end < 0) {
            //	LOG_ERROR("Error when decompressing {}, using compressed file: {}", outFile.string(),
            // utils::compress::DecompressResultName(end));
            // }
            // else {
    ...
    utils::MapAdder<ImplWorker, bo6::T10HashAssetType, Worker> impl{ GetWorkers(),
                                                                     bo6::T10HashAssetType::T10H_ASSET_LUAFILE,
                                                                     sizeof(LuaFile) };
} // namespace
