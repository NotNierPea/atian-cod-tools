...
namespace {
    ...
    utils::MapAdder<ImplWorker, bo6::T10HashAssetType, Worker> impl{ GetWorkers(),
                                                                     bo6::T10HashAssetType::T10H_ASSET_GSCOBJ,
                                                                     sizeof(GscObj) };
    utils::MapAdder<ImplWorkerGdb, bo6::T10HashAssetType, Worker> implGdb{ GetWorkers(),
                                                                           bo6::T10HashAssetType::T10H_ASSET_GSCGDB,
                                                                           sizeof(GscGdb) };
} // namespace