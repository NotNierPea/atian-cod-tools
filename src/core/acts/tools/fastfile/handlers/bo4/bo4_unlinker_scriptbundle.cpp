...
namespace fastfile::handlers::bo4::scriptbundle {
        ...
        if (arr.sbObjectCount && !IsValidHandle(arr.sbObjects)) {
            ...
            for (size_t i = 0; i < arr.sbObjectCount; i++) {
                ...
                if (!keyScrName || !*keyScrName)
                    keyScrName = hashutils::ExtractPtr(obj.keyName.name); // 64
    ...
    class ScriptBundleWorker : public Worker {
        ...
        void Unlink(fastfile::FastFileOption& opt, void* ptr) {
            ...
            std::filesystem::path outFile{
                opt.m_output / "bo4" / "source" / "scriptbundle" /
    ...
    utils::MapAdder<ScriptBundleWorker, games::bo4::pool::XAssetType, Worker> impl{
        GetWorkers(), games::bo4::pool::XAssetType::ASSET_TYPE_SCRIPTBUNDLE
    };
    utils::MapAdder<ScriptBundleListWorker, games::bo4::pool::XAssetType, Worker> impllist{
        GetWorkers(), games::bo4::pool::XAssetType::ASSET_TYPE_SCRIPTBUNDLELIST
    };
} // namespace fastfile::handlers::bo4::scriptbundle