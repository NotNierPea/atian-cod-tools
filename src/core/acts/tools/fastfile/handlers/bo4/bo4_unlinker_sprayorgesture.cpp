...
namespace {
    ...
    class SprayOrGestureListWorker : public Worker {
        void Unlink(fastfile::FastFileOption& opt, void* ptr) {
            ...
            std::filesystem::path outFile{ opt.m_output / "bo4" / "source" / "tables" / "sprayorgesture" / "list" /
    ...
    utils::MapAdder<SprayOrGestureWorker, games::bo4::pool::XAssetType, Worker> impl{
        GetWorkers(), games::bo4::pool::XAssetType::ASSET_TYPE_SPRAYORGESTUREITEM
    };
    utils::MapAdder<SprayOrGestureListWorker, games::bo4::pool::XAssetType, Worker> impllist{
        GetWorkers(), games::bo4::pool::XAssetType::ASSET_TYPE_SPRAYORGESTURELIST
    };
} // namespace