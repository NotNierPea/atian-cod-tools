...
namespace {
    ...
    class ImplWorker : public Worker {
        ...
        void Unlink(fastfile::FastFileOption& opt, void* ptr) {
            ...
            std::filesystem::path outFile{ opt.m_output / "bo4" / "source" / "tables" / "arenaseasons" /
                    ...
                    if (season.seasonDefinition) {
                        ...
                        if (season.seasonDefinition->schedules) {
                            ...
                            for (size_t j = 0; j < season.seasonDefinition->schedulesCount; j++) {
                                ...
                                if (sch->unk10)
                                    json.WriteFieldValueNumber("sch:unk10", sch->unk10);
                                if (sch->events) {
    ...
    utils::MapAdder<ImplWorker, games::bo4::pool::XAssetType, Worker> impl{
        GetWorkers(), games::bo4::pool::XAssetType::ASSET_TYPE_ARENASEASONS
    };
} // namespace