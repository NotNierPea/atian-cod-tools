...
namespace fastfile::handlers::bo4::map {
    ...
    class CustomizationTableWorker : public Worker {
        ...
        void Unlink(fastfile::FastFileOption& opt, void* ptr) {
            ...
            std::filesystem::path outFile{ opt.m_output / "bo4" / "source" / "tables" / "customization" /
    ...
    class CustomizationFEImagesTableWorker : public Worker {
        ...
        void Unlink(fastfile::FastFileOption& opt, void* ptr) {
            ...
            std::filesystem::path outFile{ opt.m_output / "bo4" / "source" / "tables" / "customization" / "feimages" /
                                           std::format("{}.json", hashutils::ExtractTmp("file", asset.name)) };
    ...
    utils::MapAdder<CustomizationTableWorker, games::bo4::pool::XAssetType, Worker> implcom{
        GetWorkers(), games::bo4::pool::XAssetType::ASSET_TYPE_CUSTOMIZATION_TABLE
    };
    utils::MapAdder<CustomizationFEImagesTableWorker, games::bo4::pool::XAssetType, Worker> implcomimg{
        GetWorkers(), games::bo4::pool::XAssetType::ASSET_TYPE_CUSTOMIZATION_TABLE_FE_IMAGES
    };
} // namespace fastfile::handlers::bo4::map