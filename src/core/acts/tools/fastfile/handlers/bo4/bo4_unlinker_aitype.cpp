...
namespace {
    ...
    class AiTypeWorker : public Worker {
        void Unlink(fastfile::FastFileOption& opt, void* ptr) {
            ...
            json.WriteFieldNameString("category");
            json.WriteValueString(GetAICategoryName(asset.category));
            json.WriteFieldNameString("fireMode");
            json.WriteValueString(GetAIWeaponFireTypeName(asset.fireMode));
            json.WriteFieldNameString("team");
            json.WriteValueString(GetTeamName(asset.team));
            ...
            json.WriteValueBool(asset.ignoresDamageHitLocations);
            json.WriteFieldNameString("ignoreVortices");
            json.WriteValueBool(asset.ignoreVortices);
            json.WriteFieldNameString("usesCovernodes");
            json.WriteValueBool(asset.usesCovernodes);
            json.WriteFieldNameString("accurateFire");
            json.WriteValueBool(asset.accurateFire);
            json.WriteFieldNameString("aggressiveMode");
            json.WriteValueBool(asset.aggressiveMode);
            json.WriteFieldNameString("hero");
            json.WriteValueBool(asset.hero);
            json.WriteFieldNameString("matureGib");
            json.WriteValueBool(asset.matureGib);
            json.WriteFieldNameString("restrictedGib");
            json.WriteValueBool(asset.restrictedGib);
            json.WriteFieldNameString("allowFriendlyFire");
            json.WriteValueBool(asset.allowFriendlyFire);
            json.WriteFieldNameString("fixedNode");
            json.WriteValueBool(asset.fixedNode);
            json.WriteFieldNameString("isPacifist");
            json.WriteValueBool(asset.isPacifist);
            json.WriteFieldNameString("threatIgnoreVehicles");
            json.WriteValueBool(asset.threatIgnoreVehicles);
            json.WriteFieldNameString("proceduralTraversals");
            json.WriteValueBool(asset.proceduralTraversals);
            json.WriteFieldNameString("canFlank");
            json.WriteValueBool(asset.canFlank);
            json.WriteFieldNameString("burstCountMin");
            json.WriteValueNumber(asset.burstCountMin);
            json.WriteFieldNameString("burstCountMax");
            json.WriteValueNumber(asset.burstCountMax);
            json.WriteFieldNameString("fireIntervalmin");
            json.WriteValueNumber(asset.fireIntervalmin);
            json.WriteFieldNameString("fireIntervalmax");
            json.WriteValueNumber(asset.fireIntervalmax);
            json.WriteFieldNameString("physRadius");
            json.WriteValueNumber(asset.physRadius);
            json.WriteFieldNameString("physHeight");
            json.WriteValueNumber(asset.physHeight);
            json.WriteFieldNameString("pathEnemyFightDist");
            json.WriteValueNumber(asset.pathEnemyFightDist);
            json.WriteFieldNameString("runAndGunDist");
            json.WriteValueNumber(asset.runAndGunDist);
            json.WriteFieldNameString("faceEnemyDist");
            json.WriteValueNumber(asset.faceEnemyDist);
            json.WriteFieldNameString("coverNodeSearchInterval");
            json.WriteValueNumber(asset.coverNodeSearchInterval);
            json.WriteFieldNameString("newThreatDelay");
            json.WriteValueNumber(asset.newThreatDelay);
            json.WriteFieldNameString("newPainDelay");
            json.WriteValueNumber(asset.newPainDelay);
            json.WriteFieldNameString("defaultGoalRadius");
            json.WriteValueNumber(asset.defaultGoalRadius);
            json.WriteFieldNameString("sightDist");
            json.WriteValueNumber(asset.sightDist);
            json.WriteFieldNameString("painTolerance");
            json.WriteValueNumber(asset.painTolerance);
            json.WriteFieldNameString("animMappingTableDefault");
            json.WriteValueNumber(asset.animMappingTableDefault);
            json.WriteFieldNameString("engageMinDist");
            json.WriteValueNumber(asset.engageMinDist);
            json.WriteFieldNameString("engageMinFalloffDist");
            json.WriteValueNumber(asset.engageMinFalloffDist);
            json.WriteFieldNameString("engageMaxDist");
            json.WriteValueNumber(asset.engageMaxDist);
            json.WriteFieldNameString("engageMaxFalloffDist");
            json.WriteValueNumber(asset.engageMaxFalloffDist);
            json.WriteFieldNameString("shootAngleThreshold");
            json.WriteValueNumber(asset.shootAngleThreshold);
            json.WriteFieldNameString("closeShootAngleThreshold");
            json.WriteValueNumber(asset.closeShootAngleThreshold);
            json.WriteFieldNameString("closeShootAngleDistance");
            json.WriteValueNumber(asset.closeShootAngleDistance);
            json.WriteFieldNameString("favorTraversalFactor");
            json.WriteValueNumber(asset.favorTraversalFactor);
            json.WriteFieldNameString("favorSpecialTraversalFactor");
            json.WriteValueNumber(asset.favorSpecialTraversalFactor);
            json.WriteFieldNameString("flankingScoreScale");
            json.WriteValueNumber(asset.flankingScoreScale);
            json.WriteFieldNameString("flankingAngle");
            json.WriteValueNumber(asset.flankingAngle);
            auto WriteCoverOffset = [&json](const char* name, CoverOffset& off) {
                json.WriteFieldNameString(name);
                json.BeginObject();
                json.WriteFieldNameString("xOffset");
                json.WriteValueNumber(off.xOffset);
                json.WriteFieldNameString("yOffset");
                json.WriteValueNumber(off.yOffset);
                json.WriteFieldNameString("yawOffset");
                json.WriteValueNumber(off.yawOffset);
                json.EndObject();
            };
            ...
            for (AISteering& steer : asset.steering) {
                json.BeginObject();
                json.WriteFieldNameString("turnRate");
                json.WriteValueNumber(steer.turnRate);
                json.WriteFieldNameString("maxTurnRateAngle");
                json.WriteValueNumber(steer.maxTurnRateAngle);
                json.WriteFieldNameString("sensorSize");
                json.WriteValueNumber(steer.sensorSize);
                json.WriteFieldNameString("collisionPenalty");
                json.WriteValueNumber(steer.collisionPenalty);
                json.WriteFieldNameString("dodgingPenalty");
                json.WriteValueNumber(steer.dodgingPenalty);
                json.WriteFieldNameString("penetrationPenalty");
                json.WriteValueNumber(steer.penetrationPenalty);
                json.WriteFieldNameString("sidednessChangingPenalty");
                json.WriteValueNumber(steer.sidednessChangingPenalty);
                json.WriteFieldNameString("velocityHysteresis");
                json.WriteValueNumber(steer.velocityHysteresis);
                json.EndObject();
            }
            json.EndArray();
            ...
            json.BeginObject();
            {
                json.WriteFieldNameString("highlightDistance");
                json.WriteValueNumber(asset.demoLockOn.highlightDistance);
                json.WriteFieldNameString("views");
                json.BeginArray();
                for (AIDemoLockOnView& view : asset.demoLockOn.views) {
                    json.BeginObject();
                    json.WriteFieldNameString("heightOffset");
                    json.WriteValueNumber(view.heightOffset);
                    json.WriteFieldNameString("pitchMin");
                    json.WriteValueNumber(view.pitchMin);
                    json.WriteFieldNameString("pitchMax");
                    json.WriteValueNumber(view.pitchMax);
                    json.EndObject();
                }
                json.EndArray();
            }
            json.EndObject();
            json.WriteFieldNameString("frontQuadrantDegrees");
            json.WriteValueNumber(asset.frontQuadrantDegrees);
            json.WriteFieldNameString("backQuadrantDegrees");
            json.WriteValueNumber(asset.backQuadrantDegrees);
            json.WriteFieldNameString("leftQuadrantDegrees");
            json.WriteValueNumber(asset.leftQuadrantDegrees);
            json.WriteFieldNameString("rightQuadrantDegrees");
            json.WriteValueNumber(asset.rightQuadrantDegrees);
            json.WriteFieldNameString("thresholds");
            json.BeginArray();
            for (FaceQuadrantThreshold& threshold : asset.thresholds) {
                json.BeginObject();
                json.WriteFieldNameString("forwardDot");
                json.WriteValueNumber(threshold.forwardDot);
                json.WriteFieldNameString("sideDot");
                json.WriteValueNumber(threshold.sideDot);
                json.EndObject();
            }
            json.EndArray();
            json.EndObject();

            std::filesystem::path outFile{ opt.m_output / "bo4" / "source" / "tables" / "aitype" /
    ...
    utils::MapAdder<AiTypeWorker, games::bo4::pool::XAssetType, Worker> impl{
        GetWorkers(), games::bo4::pool::XAssetType::ASSET_TYPE_AITYPE
    };
} // namespace