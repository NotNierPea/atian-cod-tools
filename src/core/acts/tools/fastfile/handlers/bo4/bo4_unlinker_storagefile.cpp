...
namespace {
    ...
    class ImplWorker : public Worker {
        void Unlink(fastfile::FastFileOption& opt, void* ptr) {
            ...
            std::filesystem::path outFile{ opt.m_output / "bo4" / "source" / "tables" / "storagefile" /
    ...
    utils::MapAdder<ImplWorker, games::bo4::pool::XAssetType, Worker> impl{
        GetWorkers(), games::bo4::pool::XAssetType::ASSET_TYPE_STORAGEFILE
    };
    utils::MapAdder<ImplListWorker, games::bo4::pool::XAssetType, Worker> impll{
        GetWorkers(), games::bo4::pool::XAssetType::ASSET_TYPE_STORAGEFILELIST
    };
} // namespace