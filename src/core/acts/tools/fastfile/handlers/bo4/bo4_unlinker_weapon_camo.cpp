...
namespace {
    ...
    class WeaponCamoWorker : public Worker {
        void Unlink(fastfile::FastFileOption& opt, void* ptr) {
            ...
            std::filesystem::path outFile{ opt.m_output / "bo4" / "source" / "tables" / "weaponcamo" /
                                           std::format("{}.json", n) };
    ...
    utils::MapAdder<WeaponCamoWorker, games::bo4::pool::XAssetType, Worker> impl{
        GetWorkers(), games::bo4::pool::XAssetType::ASSET_TYPE_WEAPON_CAMO
    };
} // namespace