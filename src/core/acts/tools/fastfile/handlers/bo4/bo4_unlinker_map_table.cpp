...
namespace fastfile::handlers::bo4::map {
    ...
    class MapTableWorker : public Worker {
        void Unlink(fastfile::FastFileOption& opt, void* ptr) override {
            ...
            if (asset.dlcIndex)
                json.WriteFieldValueNumber("dlcIndex", asset.dlcIndex);
            if (asset.campaignMode)
                json.WriteFieldValueNumber("campaignMode", asset.campaignMode);
            ...
            std::filesystem::path outFile{ opt.m_output / "bo4" / "source" / "tables" / "map" /
    ...
    class MapTablListWorker : public Worker {
        void Unlink(fastfile::FastFileOption& opt, void* ptr) override {
            ...
            std::filesystem::path outFile{ opt.m_output / "bo4" / "source" / "tables" / "map" / "list" /
                                           std::format("{}.json", hashutils::ExtractTmp("file", asset.name)) };
    ...
    class MapTableImagesWorker : public Worker {
      ...
      public:
        ...
        void Unlink(fastfile::FastFileOption& opt, void* ptr) override {
            ...
            std::filesystem::path outFile{ opt.m_output / "bo4" / "source" / "tables" / "map" / type /
                                           std::format("{}.json", hashutils::ExtractTmp("file", asset.name)) };
    ...
    utils::MapAdder<MapTableWorker, games::bo4::pool::XAssetType, Worker> impltable{
        GetWorkers(), games::bo4::pool::XAssetType::ASSET_TYPE_MAPTABLE
    };
    utils::MapAdder<MapTablListWorker, games::bo4::pool::XAssetType, Worker> impltablelist{
        GetWorkers(), games::bo4::pool::XAssetType::ASSET_TYPE_MAPTABLE_LIST
    };
    utils::MapAdder<MapTableImagesWorker, games::bo4::pool::XAssetType, Worker> implimgl{
        GetWorkers(), games::bo4::pool::XAssetType::ASSET_TYPE_MAPTABLE_LOADING_IMAGES, "loadingimages"
    };
    utils::MapAdder<MapTableImagesWorker, games::bo4::pool::XAssetType, Worker> implimgp{
        GetWorkers(), games::bo4::pool::XAssetType::ASSET_TYPE_MAPTABLE_PREVIEW_IMAGES, "previewimages"
    };
} // namespace fastfile::handlers::bo4::map