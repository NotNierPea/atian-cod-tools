...
namespace fastfile::handlers::bo4::map {
    ...
    static const char* spawnVarKeyTypeNames[]{
        "unk_0", "unk_1", "string", "vector", "xhash", "float", "int",
    };
                ...
                for (size_t i = 0; i < asset.spawnVarsCount; i++) {
                    ...
                    if (var->spawnVars) {
                        ...
                        for (size_t j = 0; j < var->numSpawnVars; j++) {
                            ...
                            if (spawnVar->unk1a)
                                json.WriteFieldValueBool("unk1a", spawnVar->unk1a);
                            json.EndObject();
                        }
                        json.EndArray();
                    }
    ...
    utils::MapAdder<TriggerListWorker, games::bo4::pool::XAssetType, Worker> implcom{
        GetWorkers(), games::bo4::pool::XAssetType::ASSET_TYPE_TRIGGER_LIST
    };
} // namespace fastfile::handlers::bo4::map