...
namespace {
    ...
    class ImplWorker : public Worker {
        void Unlink(fastfile::FastFileOption& opt, void* ptr) {
            ...
            // refs
            constexpr size_t postWeaponDefNameField =
                offsetof(CharacterBodyType, name) + sizeof(CharacterBodyType::name);
    ...
    utils::MapAdder<ImplWorker, games::bo4::pool::XAssetType, Worker> impl{
        GetWorkers(), games::bo4::pool::XAssetType::ASSET_TYPE_CHARACTER_BODY_TYPE
    };
} // namespace