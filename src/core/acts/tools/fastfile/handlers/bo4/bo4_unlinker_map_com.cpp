...
namespace fastfile::handlers::bo4::map {
    ...
    class ComWorldWorker : public Worker {
        ...
        void Unlink(fastfile::FastFileOption& opt, void* ptr) {
            ...
            if (asset.isInUse)
                json.WriteFieldValueBool("isInUse", asset.isInUse);
    ...
    utils::MapAdder<ComWorldWorker, games::bo4::pool::XAssetType, Worker> implcom{
        GetWorkers(), games::bo4::pool::XAssetType::ASSET_TYPE_COMWORLD
    };
} // namespace fastfile::handlers::bo4::map