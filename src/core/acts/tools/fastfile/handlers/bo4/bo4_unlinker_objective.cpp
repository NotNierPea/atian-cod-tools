...
namespace {
    ...
    class ImplWorker : public Worker {
        ...
        void Unlink(fastfile::FastFileOption& opt, void* ptr) {
            ...
            std::filesystem::path outFile{ opt.m_output / "bo4" / "source" / "tables" / "objective" /
            ...
            if (asset->unk25)
                json.WriteFieldValueNumber("unk25", (int)asset->unk25);
            if (asset->unk28)
                json.WriteFieldValueUnknown("unk28", asset->unk28); // unused?
            if (asset->unk30)
                json.WriteFieldValueNumber("unk30", asset->unk30);
            if (asset->unk34)
                json.WriteFieldValueNumber("unk34", asset->unk34); // 0.08?
            if (asset->unk4f)
                json.WriteFieldValueNumber("unk4f", (int)asset->unk4f); // pad?
            if (asset->unk54)
                json.WriteFieldValueNumber("unk54", (int)asset->unk54);
            if (asset->unk55)
                json.WriteFieldValueNumber("unk55", (int)asset->unk55); // unused?
            if (asset->unk56)
                json.WriteFieldValueNumber("unk56", (int)asset->unk56); // unused?
            if (asset->unk57)
                json.WriteFieldValueNumber("unk57", (int)asset->unk57); // unused?
            if (asset->unk58)
                json.WriteFieldValueNumber("unk58", asset->unk58);
            if (asset->unk5c)
                json.WriteFieldValueUnknown("unk5c", asset->unk5c); // pad?
            if (asset->unk60)
                json.WriteFieldValueNumber("unk60", asset->unk60); // 70?
            if (asset->unk64)
                json.WriteFieldValueNumber("unk64", asset->unk64); // 40?
    ...
    utils::MapAdder<ImplWorker, games::bo4::pool::XAssetType, Worker> impl{
        GetWorkers(), games::bo4::pool::XAssetType::ASSET_TYPE_OBJECTIVE
    };
} // namespace