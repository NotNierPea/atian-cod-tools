...
namespace {
    ...
    class ScriptParseTreeForcedWorker : public Worker {
        void Unlink(fastfile::FastFileOption& opt, void* ptr) {
            ...
            std::filesystem::path outFile{ opt.m_output / "bo4" / "source" / "tables" / "scriptparsetreeforced" /
                                           std::format("{}.csv", n) };
    ...
    utils::MapAdder<ScriptParseTreeForcedWorker, games::bo4::pool::XAssetType, Worker> impl{
        GetWorkers(), games::bo4::pool::XAssetType::ASSET_TYPE_SCRIPTPARSETREEFORCED
    };
} // namespace