...
namespace fastfile {
    ...
    namespace flexible {
        ...
        inline PFFIWDeps& GetIWDeps(FlexibleFastFileReader& reader) {
            return *reader.GetChunkVal<PFFIWDeps>(SectionType::ST_IW_DEPS, true);
        }
        inline PFFIWChecksums& GetIWChecksums(FlexibleFastFileReader& reader) {
            return *reader.GetChunkVal<PFFIWChecksums>(SectionType::ST_IW_FASTFILE_CHECKSUM, true);
        }
        inline PFFIW_0xc95c6b9c& GetIWUnkc95c6b9c(FlexibleFastFileReader& reader) {
            return *reader.GetChunkVal<PFFIW_0xc95c6b9c>(SectionType::ST_IW_UNK_0xc95c6b9c, true);
        }
    } // namespace flexible
} // namespace fastfile