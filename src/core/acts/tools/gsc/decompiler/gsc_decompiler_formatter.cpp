...
namespace tool::gsc::formatter {
    ...
    const FormatterInfo& GetDefaultFormatter() { return treyarchFormatter.InitAndGet(); }
    ...
    const std::vector<FormatterInfo*>& GetFormatters() { return formatters; }
