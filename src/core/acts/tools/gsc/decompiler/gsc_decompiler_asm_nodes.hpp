...
namespace tool::gsc::opcode {
    ...
    class ASMContextNodeValue : public ASMContextNodeValueVir {
      public:
        ...
        bool IsIntConst() const override { return m_isIntConst; }

        int64_t GetIntConst() const override { return (int64_t)m_value; }
    ...
    class ASMContextNodeIdentifier : public ASMContextNode {
      public:
        ...
        const char* m_type;
        const char* m_strVal;
        ASMContextNodeIdentifier(uint64_t value, const char* type = "var", const char* idf = nullptr)
            : ASMContextNode(PRIORITY_VALUE, TYPE_IDENTIFIER), m_value(value), m_type(type), m_strVal(idf) {}
        ASMContextNodeIdentifier(const char* idf)
            : ASMContextNode(PRIORITY_VALUE, TYPE_IDENTIFIER), m_value(hash::Hash64(idf)), m_type("hash"),
              m_strVal(idf) {}
        ...
        ASMContextNode* Clone0() const override { return new ASMContextNodeIdentifier(m_value, m_type, m_strVal); }
    };
    ...
    class ASMContextNodeHash : public ASMContextNode {
      public:
        ...
        ASMContextNodeHash(uint64_t value, bool canonid = false, const char* type = "#", bool localized = false)
            : m_type(type), ASMContextNode(PRIORITY_VALUE, TYPE_CONST_HASH), m_value(value), m_canonid(canonid),
              m_localized(localized) {}

        void Dump(std::ostream& out, DecompContext& ctx) const override {
            if (m_localized && ctx.opt.LookupLocalizedFunc) {
                out << m_type << "\"" << utils::FormattedString(ctx.opt.LookupLocalizedFunc(m_value)) << '"'
                    << std::flush;
            } else if (m_canonid) {
        ...
        int64_t GetIntConst() const override { return static_cast<int64_t>(m_value); }
    };
    ...
    class ASMContextNodeVectorN : public ASMContextNode {
      public:
        ...
        NodePtr* nodes;
        size_t count;
        ASMContextNodeVectorN(ASMContextNode** nodes, size_t count)
            : ASMContextNode(PRIORITY_VALUE, TYPE_VECTORN), count(count), nodes(nodes) {}
        ASMContextNodeVectorN(float* vector, size_t count)
            : ASMContextNode(PRIORITY_VALUE, TYPE_VECTORN), count(count) {
    ...
    class ASMContextNodeString : public ASMContextNode {
      public:
        ...
        ASMContextNode* Clone0() const override { return new ASMContextNodeString(m_value, m_prefix, m_allowNoQuote); }
    };
    ...
    class ASMContextNodeAnimation : public ASMContextNode {
      public:
        const char* m_str1;
        const char* m_str2;
        ASMContextNodeAnimation(const char* str1, const char* str2)
            : ASMContextNode(PRIORITY_VALUE), m_str1(str1), m_str2(str2) {}
        ...
        ASMContextNode* Clone0() const override { return new ASMContextNodeAnimation(m_str1, m_str2); }
    };
    ...
    class ASMContextNodeAnimationRender : public ASMContextNode {
      public:
        ...
        ASMContextNode* Clone0() const override { return new ASMContextNodeAnimationRender(m_name); }
    };
    ...
    class ASMContextNodeFuncRef : public ASMContextNode {
      public:
        ...
        uint64_t m_nsp;
        uint64_t m_script;
        ASMContextNodeFuncRef(const char* op, uint64_t func, uint64_t nsp = 0, uint64_t script = 0)
            : ASMContextNode(PRIORITY_VALUE, TYPE_FUNC_REFNAME), m_op(op), m_func(func), m_nsp(nsp), m_script(script) {}
        ...
        ASMContextNode* Clone0() const override { return new ASMContextNodeFuncRef(m_op, m_func, m_nsp, m_script); }
    };
    ...
    class ASMContextNodeRef : public ASMContextNode {
      public:
        ...
        ASMContextNodeRef(const char* op, ASMContextNode* var)
            : ASMContextNode(PRIORITY_VALUE, TYPE_GET_REF), m_op(op), m_var(var) {}
    ...
    class ASMContextNodeArrayAccess : public ASMContextNode {
      public:
        ...
        ASMContextNodeArrayAccess(ASMContextNode* operandleft, ASMContextNode* operandright)
            : ASMContextNode(PRIORITY_ACCESS, TYPE_ARRAY_ACCESS), m_operandleft(operandleft),
              m_operandright(operandright) {}
    ...
    class ASMContextNodeArrayBuild : public ASMContextNode {
      public:
        ...
        ASMContextNodeArrayBuild() : ASMContextNode(PRIORITY_ACCESS, TYPE_ARRAY_BUILD) {}
    ...
    class ASMContextNodeStructBuild : public ASMContextNode {
      public:
        std::vector<ASMContextNodeArrayBuildNode*> m_operands{};
        ASMContextNodeStructBuild() : ASMContextNode(PRIORITY_ACCESS, TYPE_STRUCT_BUILD) {}
    ...
    enum ASMContextNodeCallFuncPtrType { CLASS_CALL, PARAMS_CALL, POINTER_CALL, FUNCTION_CALL };

    enum ASMContextNodeCallFuncFlag : byte { THREAD_CALL = 1, CHILDTHREAD_CALL = 2, SELF_CALL = 4, BUILTIN_CALL = 8 };
    ...
    class ASMContextNodeCallFuncPtr : public ASMContextNode {
      public:
        ...
        void AddParam(ASMContextNode* node) { m_operands.push_back(node); }
        ...
        bool IsBoolConvertable(bool strict, ASMContext& ctx) override {
            ...
            if (idx >= m_operands.size())
                return false; // wtf
            if (m_operands[idx]->m_type != TYPE_FUNC_REFNAME)
                return false; // not a named call
        ...
        ASMContextNode* ConvertToBool() { return this; }
    ...
    class ASMContextNodeTernary : public ASMContextNode {
      public:
        ...
        ASMContextNodeTernary(ASMContextNode* operand1, ASMContextNode* operand2, ASMContextNode* operand3)
            : ASMContextNode(PRIORITY_TERNARY, TYPE_TERNARY), m_operand1(operand1), m_operand2(operand2),
              m_operand3(operand3) {}
    ...
    class ASMContextNodeOp2 : public ASMContextNode {
      public:
        ...
        ASMContextNode* ConvertToBool() override { return m_isBoolValue ? this : nullptr; }
    ...
    class ASMContextNodeOp1 : public ASMContextNode {
      public:
        ...
        ~ASMContextNodeOp1() { delete m_operand; }
    ...
    class ASMContextNodeMultOp : public ASMContextNode {
      public:
        ...
        bool IsBoolConvertable(bool strict, ASMContext& ctx) override { return m_isBoolVal; }
        ...
        void Dump(std::ostream& out, DecompContext& ctx) const override {
            ...
            if (!m_noParenthesis) {
                ...
                if (start < m_operands.size() &&
                    (ctx.opt.m_formatter->HasFlag(tool::gsc::formatter::FFL_SPACE_BEFOREAFTER_PARAMS))) {
                    out << " ";
                }
    ...
    enum ASMContextNodeJumpOperatorSpecialJump { SPECIAL_JUMP_DEFAULT = 0, SPECIAL_JUMP_BREAK, SPECIAL_JUMP_CONTINUE };
        ...
        void Dump(std::ostream& out, DecompContext& ctx) const override {
            ...
            if (ctx.opt.m_show_jump_delta) {
                out << " delta: " << std::hex << (m_delta < 0 ? "-0x" : "0x") << (m_delta < 0 ? -m_delta : m_delta)
                    << " (type:" << m_type << "/spec:" << (m_special_op ? "true" : "false") << ")";
            }
            if (fakeIf) {
                out << ";\n";
                ctx.padding--;
    ...
    class ASMContextNodeCodeRef : public ASMContextNode {
      public:
        ...
        ASMContextNode* Clone0() const override { return new ASMContextNodeCodeRef(m_location); }
    ...
    class ASMContextNodeNew : public ASMContextNode {
      public:
        ...
        ASMContextNodeNew(uint32_t clsName, ASMContextNode* constructorCall = nullptr, bool constructorCallDec = false)
            : ASMContextNode(PRIORITY_VALUE, TYPE_NEW), m_classname(clsName), m_constructorCall(constructorCall),
              m_constructorCallDec(constructorCallDec) {}
        ~ASMContextNodeNew() {
    ...
    class ASMContextNodeSwitchPreCompute : public ASMContextNode {
      public:
        ...
        void Dump(std::ostream& out, DecompContext& ctx) const override {
            ...
            ctx.WritePadding(out, true) << "end: ." << std::hex << std::setfill('0') << std::setw(sizeof(int32_t) << 1)
                                        << m_endLocation << ";\n";
            if (ctx.opt.m_formatter->HasFlag(tool::gsc::formatter::FFL_SWITCH_PAD_CASES)) {
                ctx.padding--;
            }
        ...
        void Dump(std::ostream& out, DecompContext& ctx) const override {
            ...
            for (const auto& cs : m_cases) {
                ...
                if (emptyBlock) {
                    ...
                    if ((ctx.opt.m_formatter->HasFlag(tool::gsc::formatter::FFL_NEWLINE_AFTER_BLOCK_START)) &&
                        (ctx.opt.m_formatter->HasFlag(tool::gsc::formatter::FFL_SWITCH_FORCE_BLOCKS))) {
                        ctx.WritePadding(out << "\n", true);
                    }
    ...
    class ASMContextNodeForEach : public ASMContextNode {
      public:
        ...
        ASMContextNodeForEach(ASMContextNode* arrayNode, ASMContextNodeBlock* block, uint64_t key, uint64_t item)
            : ASMContextNode(PRIORITY_INST, TYPE_FOR_EACH), m_arrayNode(arrayNode), m_block(block), m_key(key),
              m_item(item) {
            m_renderSemicolon = false;
        }
    ...
    class ASMContextNodeIfElse : public ASMContextNode {
      public:
        ...
        ASMContextNodeIfElse(ASMContextNode* condition, ASMContextNodeBlock* ifblock, ASMContextNodeBlock* elseblock)
            : ASMContextNode(PRIORITY_INST, TYPE_IF), m_condition(condition), m_ifblock(ifblock),
