      ...
      public:
        static void OpCode() {
            VmInfo* v8b = RegisterVM(
                VMI_JUP_8B,
                "Call of Duty: Modern Warfare III (8B)",
                "jup",
                "mwiii",
            ...
            v8b->RegisterVMHashOPCode('@', OPCODE_IW_GetDVarHash, 8, [](const char* str) {
                return hash::HashIWDVar(str);
            });
            v8b->RegisterVMHashOPCode('%', OPCODE_IW_GetResourceHash, 8, [](const char* str) {
