...
namespace tool::gsc::opcode {
    class OpCodeT1013Registry {
      public:
        static void OpCode() {
            VmInfo* t1013 = RegisterVM(
                VMI_T10_13,
                "Call of Duty: Black Ops 6 (13)",
                "t10",
                "bo6_13",
            ...
            t1013->RegisterVMHashOPCode('@', OPCODE_IW_GetDVarHash, 8, [](const char* str) {
                return hash::HashIWDVar(str);
            });
            t1013->RegisterVMHashOPCode('%', OPCODE_IW_GetResourceHash, 8, [](const char* str) {
                return hash::HashIWAsset(str);
            });
            t1013->RegisterVMHashOPCode('t', OPCODE_IW_GetTagHash, 4, [](const char* str) {
                return hash::HashX32(str);
            });
            t1013->RegisterVMHashOPCode('s', OPCODE_T10_GetScrHash, 8, [](const char* str) {
                return hash::HashT10Scr(str);
            });
            t1013->RegisterDevCall(
                "assert",
                "assertmsg",
