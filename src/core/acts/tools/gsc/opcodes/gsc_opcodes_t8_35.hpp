...
namespace tool::gsc::opcode {
    class OpCodeT835Registry {
      public:
        static void OpCode() {
            VmInfo* vt835 = RegisterVM(
                VMI_T8_35,
                "Call of Duty: Black ops 4 (35)",
                "t8",
                "bo4_35",
                VmFlags::VMF_OPCODE_U16 | VmFlags::VMF_ALIGN | VmFlags::VMF_INV_ADD_TO_OBJECT | VmFlags::VMF_CLIENT_VM
            );
            ...
            vt835->RegisterVMOperatorFunction(
                "endoncallback",
                "<caller> endoncallback(func, event+)",
            ...
            vt835->RegisterVMOperatorFunction(
                "waittill",
                "<caller> waittill(event) -> struct",
                OPCODE_WaitTill,
                VPFD_SELF_PARAM | VPFD_USE_COUNT | VPFD_RETURN_VALUE,
                1
            );
            vt835->RegisterVMOperatorFunction(
                "waittillmatch",
                "<caller> waittillmatch(event, match) -> struct",
            ...
            vt835->RegisterVMOperatorFunction(
                ...
                "<caller> waittillmatchtimeout(event, match, timeout) -> struct",
            ...
            vt835->RegisterVMOperatorFunction(
                "waittilltimeout",
                "<caller> waittilltimeout(event, timeout) -> struct",
