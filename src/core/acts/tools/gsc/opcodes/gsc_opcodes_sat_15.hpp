...
namespace tool::gsc::opcode {
    class OpCodeSat15Registry {
      public:
        static void OpCode() {
            VmInfo* t1015 = RegisterVM(
                VMI_SAT_15,
                "Call of Duty: Black Ops 7 (15)",
                "t11",
                "bo7_15",
            ...
            t1015->RegisterVMHashOPCode('@', OPCODE_IW_GetDVarHash, 8, [](const char* str) {
                return hash::HashIWDVar(str);
            });
            t1015->RegisterVMHashOPCode('%', OPCODE_IW_GetResourceHash, 8, [](const char* str) {
                return hash::HashIWAsset(str);
            });
            t1015->RegisterVMHashOPCode('t', OPCODE_IW_GetTagHash, 4, [](const char* str) {
                return hash::HashX32(str);
            });
            t1015->RegisterVMHashOPCode('s', OPCODE_T10_GetScrHash, 8, [](const char* str) {
                return hash::HashT10Scr(str);
            });
            t1015->RegisterVMHashOPCode('o', OPCODE_SAT_GetOmnVarHash, 8, [](const char* str) {
                return hash::HashT10OmnVar(str);
            });
            t1015->RegisterDevCall(
                "assert",
                "assertmsg",
