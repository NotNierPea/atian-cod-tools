    ...
    class OpCodeJup8ARegistry {
      public:
        static void OpCode() {
            ...
            v8a->RegisterVMHashOPCode('@', OPCODE_IW_GetDVarHash, 8, [](const char* str) {
                return hash::HashIWDVar(str);
            });
            v8a->RegisterVMHashOPCode('%', OPCODE_IW_GetResourceHash, 8, [](const char* str) {
