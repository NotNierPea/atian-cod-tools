...
namespace tool::gsc {
    class MW23GSCOBJHandler : public GSCOBJHandler {
      public:
        ...
        uint64_t GetName() override { return Ptr<GscObj23>()->name; }
        uint16_t GetExportsCount() override { return Ptr<GscObj23>()->export_count; }
        uint32_t GetExportsOffset() override { return Ptr<GscObj23>()->export_offset; }
        uint16_t GetIncludesCount() override { return Ptr<GscObj23>()->includes_count; }
        uint32_t GetIncludesOffset() override { return Ptr<GscObj23>()->include_table; }
        uint16_t GetImportsCount() override { return Ptr<GscObj23>()->imports_count; }
        uint32_t GetImportsOffset() override { return Ptr<GscObj23>()->import_table; }
        ...
        uint16_t GetStringsCount() override { return Ptr<GscObj23>()->string_count; }
        uint32_t GetStringsOffset() override { return Ptr<GscObj23>()->string_table; }
        uint16_t GetDevStringsCount() override { return Ptr<GscObj23>()->devblock_string_count; }
        uint32_t GetDevStringsOffset() override { return Ptr<GscObj23>()->devblock_string_offset; }
        size_t GetHeaderSize() override { return sizeof(GscObj23); }
        ...
        uint16_t GetAnimTreeSingleCount() override { return Ptr<GscObj23>()->animtree_use_count; };
        uint32_t GetAnimTreeSingleOffset() override { return Ptr<GscObj23>()->animtree_use_offset; };
        uint16_t GetAnimTreeDoubleCount() override { return Ptr<GscObj23>()->animtree_count; };
        uint32_t GetAnimTreeDoubleOffset() override { return Ptr<GscObj23>()->animtree_offset; };

        void SetName(uint64_t name) override { Ptr<GscObj23>()->name = name; }
        void SetHeader() override { Ref<uint64_t>() = 0xa0d4353478a; }
        void SetExportsCount(uint16_t val) override { Ptr<GscObj23>()->export_count = val; }
        void SetExportsOffset(uint32_t val) override { Ptr<GscObj23>()->export_offset = val; }
        void SetIncludesCount(uint16_t val) override { Ptr<GscObj23>()->includes_count = val; }
        void SetIncludesOffset(uint32_t val) override { Ptr<GscObj23>()->include_table = val; }
        void SetImportsCount(uint16_t val) override { Ptr<GscObj23>()->imports_count = val; }
        void SetImportsOffset(uint32_t val) override { Ptr<GscObj23>()->import_table = val; }
        void SetStringsCount(uint16_t val) override { Ptr<GscObj23>()->string_count = val; }
        void SetStringsOffset(uint32_t val) override { Ptr<GscObj23>()->string_table = val; }
        void SetDevStringsCount(uint16_t val) override { Ptr<GscObj23>()->devblock_string_count = val; }
        void SetDevStringsOffset(uint32_t val) override { Ptr<GscObj23>()->devblock_string_offset = val; }
        void SetFileSize(uint32_t val) override {
            // idk
            Ptr<GscObj23>()->size1 = val;
            Ptr<GscObj23>()->size2 = val;
        }
        void SetCSEGOffset(uint32_t val) override { Ptr<GscObj23>()->cseg_offset = val; }
        void SetCSEGSize(uint32_t val) override { Ptr<GscObj23>()->cseg_size = val; }
        uint32_t GetCSEGOffset() override { return Ptr<GscObj23>()->cseg_offset; }
        uint32_t GetCSEGSize() override { return Ptr<GscObj23>()->cseg_size; }
        void SetAnimTreeSingleCount(uint16_t val) override { Ptr<GscObj23>()->animtree_use_count = val; }
        void SetAnimTreeSingleOffset(uint32_t val) override { Ptr<GscObj23>()->animtree_use_offset = val; }
        void SetAnimTreeDoubleCount(uint16_t val) override { Ptr<GscObj23>()->animtree_count = val; }
        void SetAnimTreeDoubleOffset(uint32_t val) override { Ptr<GscObj23>()->animtree_offset = val; }
        ...
        size_t GetExportSize() override { return sizeof(tool::gsc::IW23GSCExport); }
        ...
        void SetChecksum(uint64_t val) override { Ptr<GscObj23>()->checksum = (uint32_t)val; }
        uint32_t GetChecksum() override { return Ptr<GscObj23>()->checksum; }
        const char* GetDefaultName(bool client) override {
            return ""; // idc
        }
        bool IsVTableImportFlags(byte flags) override { return false; }
        byte GetVTableImportFlags() override { return 0; }
    };
    ...
    class MW23BGSCOBJHandler : public GSCOBJHandler {
      public:
        ...
        void SetName(uint64_t name) override { Ptr<GscObj23>()->name = name; }
        void SetHeader() override { Ref<uint64_t>() = 0xa0d4353478b; }
        void SetExportsCount(uint16_t val) override { Ptr<GscObj23>()->export_count = val; }
        void SetExportsOffset(uint32_t val) override { Ptr<GscObj23>()->export_offset = val; }
        void SetIncludesCount(uint16_t val) override { Ptr<GscObj23>()->includes_count = val; }
        void SetIncludesOffset(uint32_t val) override { Ptr<GscObj23>()->include_table = val; }
