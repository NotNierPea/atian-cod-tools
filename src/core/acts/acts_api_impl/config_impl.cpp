...
void ActsAPIConfig_SetMainConfig(const char* path) { core::config::SetMainConfig(path); }
bool ActsAPIConfig_SyncConfig(bool save) { return core::config::SyncConfig(save); }
void ActsAPIConfig_SaveConfig() { core::config::SaveConfig(); }
...
bool ActsAPIConfig_GetBool(const char* path, bool defaultValue) { return core::config::GetBool(path, defaultValue); }

void ActsAPIConfig_SetInteger(const char* path, int64_t value) { core::config::SetInteger(path, value); }
