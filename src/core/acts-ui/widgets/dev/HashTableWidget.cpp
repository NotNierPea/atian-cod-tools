...
HashTableWidget::HashTableWidget(QWidget* parent) : QWidget(parent) {
    ui.setupUi(this);
    ...
    connect(debounceTimer, &QTimer::timeout, this, [this]() { proxy->setFilterFixedString(ui.searchEdit->text()); });

    connect(ui.searchEdit, &QLineEdit::textChanged, this, [this]() { debounceTimer->start(); });
}
