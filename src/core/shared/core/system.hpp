...
#define REGISTER_SYSTEM(id, ...)                                                                                       \
    static core::system::SystemContainer __systemcontainer_##id(hash::Hash64(#id), __VA_ARGS__)
#define IGNORE_SYSTEM(id, ...)                                                                                         \
    static core::system::SystemContainer __systemcontainer_##id(hash::Hash64(#id), nullptr, nullptr, true)