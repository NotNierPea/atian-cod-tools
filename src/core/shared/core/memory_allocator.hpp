...
namespace core::memory_allocator {
    ...
    class MemoryAllocator {
      ...
      public:
        ...
        MemoryAllocator(MemoryAllocator&& other) noexcept : totalLen(other.totalLen), ptrs(std::move(other.ptrs)) {
            other.totalLen = 0;
            other.ptrs.clear();
        }
        ...
        const char* CloneStr(const std::string& str) { return CloneStr(str.data()); }
        ...
        size_t DebugAllocSize() const { return totalLen; }
    };
