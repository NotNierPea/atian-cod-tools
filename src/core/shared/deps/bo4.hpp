...
namespace deps::bo4 {
    ...
    class Bo4 {
      ...
      public:
        ...
        bool LoadFromDeps() {
            if (mod.Load("bo4.exe", true, false) || mod.Load("BlackOps4.exe", true, false) ||
                mod.Load("BlackOps4_dump.exe", true, false)) {
                bo4 = *mod;
            } else {
                bo4.ClearModule();
            }
        ...
        constexpr const hook::library::Library* operator->() const { return &bo4; }
