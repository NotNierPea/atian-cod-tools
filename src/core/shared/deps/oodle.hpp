...
namespace deps::oodle {
    ...
    enum OodleFuzeSafe : int { OODLE_FS_NO = 0, OODLE_FS_YES = 1 };

    enum OodleCheckCrcValues : int { OODLE_CRC_NO = 0, OODLE_CRC_YES = 1 };

    enum OodleVerbosity : int { OODLE_VERB_NONE = 0, OODLE_VERB_MIN = 1, OODLE_VERB_SOME = 2, OODLE_VERB_LOTS = 3 };
    ...
    class Oodle {
      ...
      public:
        ...
        constexpr operator bool() const { return oodle; }

        constexpr const hook::library::Library& GetOodleLib() const { return oodle; }
