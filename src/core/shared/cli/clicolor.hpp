...
namespace cli::clicolor {
    ...
    constexpr ColorData Reset() { return CD_RESET; }

    constexpr ColorData Color(int r, int g, int b) { return (ColorData)(16 + 36 * r + 6 * g + b); }

    constexpr ColorData ResetBackground() { return CD_RESET; }
