...
namespace actslib::io {
    ...
    template<>
    inline void WriteUInt(std::ostream& os, uint8_t value) {
        WriteUInt8(os, value);
    }
    template<>
    inline void WriteInt(std::ostream& os, int8_t value) {
        WriteInt8(os, value);
    }
    template<>
    inline void WriteUInt(std::ostream& os, uint16_t value) {
        WriteUInt16(os, value);
    }
    template<>
    inline void WriteInt(std::ostream& os, int16_t value) {
        WriteInt16(os, value);
    }
    template<>
    inline void WriteUInt(std::ostream& os, uint32_t value) {
    ...
    template<>
    inline void WriteUInt(std::ostream& os, uint64_t value) {
        WriteUInt64(os, value);
    }
    template<>
    inline void WriteInt(std::ostream& os, int64_t value) {
        WriteInt64(os, value);
    }

    template<>
    inline uint8_t ReadUInt(std::istream& is) {
        return ReadUInt8(is);
    }
    template<>
    inline int8_t ReadInt(std::istream& is) {
        return ReadInt8(is);
    }
    template<>
    inline uint16_t ReadUInt(std::istream& is) {
        return ReadUInt16(is);
    }
    template<>
    inline int16_t ReadInt(std::istream& is) {
        return ReadInt16(is);
    }
    template<>
    inline uint32_t ReadUInt(std::istream& is) {
        return ReadUInt32(is);
    }
    template<>
    inline int32_t ReadInt(std::istream& is) {
        return ReadInt32(is);
    }
    template<>
    inline uint64_t ReadUInt(std::istream& is) {
        return ReadUInt64(is);
    }
    template<>
    inline int64_t ReadInt(std::istream& is) {
        return ReadInt64(is);
    }
