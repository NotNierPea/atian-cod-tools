...
namespace actslib::crc {
    ...
    class CRC {
      public:
        ...
        constexpr void WriteCRC(std::ostream& os) const { actslib::io::WriteUInt<CRCType>(os, value); }

        constexpr bool CheckCRC(std::istream& is) const { return actslib::io::ReadUInt<CRCType>(is) == value; }
    };
