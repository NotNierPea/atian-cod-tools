...
namespace actslib {
    ...
    /*
     * format a string and return it, the string will be allocated until a MAX_VA_ALLOC amount of calls of this
     * function. The max size is MAX_VA_LEN.
     * @param fmt format
     * @return va string
     */
