...
namespace actslib::io {
    ...
    uint16_t ReadUInt16(std::istream& is) {
        ...
        return (buffer[0] & 0xFFUL) | ((buffer[1] & 0xFFUL) << 8);
    }
    ...
    uint32_t ReadUInt32(std::istream& is) {
        ...
        return (buffer[0] & 0xFFUL) | ((buffer[1] & 0xFFUL) << 8) | ((buffer[2] & 0xFFUL) << 16) |
               ((buffer[3] & 0xFFUL) << 24);
    }
    ...
    uint64_t ReadUInt64(std::istream& is) {
        ...
        return (buffer[0] & 0xFFULL) | ((buffer[1] & 0xFFULL) << 8) | ((buffer[2] & 0xFFULL) << 16) |
               ((buffer[3] & 0xFFULL) << 24) | ((buffer[4] & 0xFFULL) << 32) | ((buffer[5] & 0xFFULL) << 40) |
               ((buffer[6] & 0xFFULL) << 48) | ((buffer[7] & 0xFFULL) << 56);
    }
    ...
    void WriteUInt8(std::ostream& os, uint8_t value) { os.write((const char*)&value, sizeof(value)); }

    void WriteInt8(std::ostream& os, int8_t value) { WriteUInt8(os, *reinterpret_cast<uint8_t*>(&value)); }
    ...
    void WriteInt16(std::ostream& os, int16_t value) { WriteUInt16(os, *reinterpret_cast<uint16_t*>(&value)); }
    ...
    void WriteInt32(std::ostream& os, int32_t value) { WriteUInt32(os, *reinterpret_cast<uint32_t*>(&value)); }
    ...
    void WriteInt64(std::ostream& os, int64_t value) { WriteUInt64(os, *reinterpret_cast<uint64_t*>(&value)); }
