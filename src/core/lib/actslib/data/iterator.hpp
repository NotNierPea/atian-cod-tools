...
namespace actslib::data::iterator {
    ...
    class AIterator {
      public:
        ...
        inline bool operator!() { return !(bool)(*this); }
    };

    template<typename Type>
    class EmptyAIterator : public AIterator<Type> {
      public:
        EmptyAIterator<Type>& operator++() override { return *this; }
        Type& operator*() override { throw std::runtime_error("Empty iterator"); }
    ...
    class HandleAIterator : public AIterator<Type> {
      ...
      public:
        ...
        Type& operator*() override { return *it; }
        operator bool() override { return it != end; }
    };

    template<typename Type>
    class MergeIteratorBasicComp {
      public:
        static constexpr bool Compare(Type& a, Type& b) { return a < b; }
    };
...
#undef max
        ...
        Type& operator*() override { return **main; }

        operator bool() override { return (*main); }
    };
} // namespace actslib::data::iterator