...
typedef enum { ActsAPITool_OK = 0, ActsAPITool_BASIC_ERROR = -1, ActsAPITool_BAD_USAGE = -2 } ActsAPITool_ERROR;
 ...
 * @param func function callback
 */
#define ActsAPITool_RegisterActsTool(name, category, usage, description, func)                                         \
    ActsAPITool_RegisterActsTool_(name, __FILE__, __LINE__, category, usage, description, func)
/*
